...
# EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="iceberg" -DDUCKDB_OOT_EXTENSION_ICEBERG_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_ICEBERG_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_ICEBERG_INCLUDE_PATH="$(PROJ_DIR)src/include"
EXTENSION_FLAGS=-DEXTERNAL_EXTENSION_DIRECTORIES=../../duckdb-iceberg-extension
pull:
	git submodule init
